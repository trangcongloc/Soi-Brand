 ...
 * Eliminates duplicate JSON.parse/try-catch patterns across the Prompt module
 */
...
const jobUpdateChannel =
  typeof BroadcastChannel !== "undefined"
    ? new BroadcastChannel("prompt-job-updates")
    : null;

/**
 * Dispatches a custom event to notify components of Prompt job updates

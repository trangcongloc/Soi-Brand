/**
 * Prompt Pipeline - Prompt templates for scene generation
 */

import { GeminiRequestBody, GeminiPart, VoiceLanguage, AudioSettings, GeneratedScript, DirectBatchInfo, CharacterSkeleton, CharacterExtractionResult, CinematicProfile, ColorProfileExtractionResult, VideoAnalysisResult, StyleObject, MediaType, SceneCountMode } from "./types";
...
/**
 * System instruction for combined video analysis (color profile + characters)
 */
...
/**
 * User prompt for combined video analysis
 */
...
/**
 * Response schema for combined video analysis
 */
 ...
 * This extracts both color profile AND characters in a single API call
 */
...
export function parseVideoAnalysisResponse(response: {
  ...
  // Normalize color profile using existing function
...
CHARACTER FORMAT: "Name - tags..." (15+ attributes for Prompt 3 consistency)
...
// ============================================================================
// Prompt 3: Selfie Mode (genuine mode switch — only toggle kept)
// ============================================================================

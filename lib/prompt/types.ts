/**
 * Prompt Pipeline - TypeScript interfaces
 */
...
export type PromptMode = "direct" | "hybrid";
...
/**
 * Granular audio layer controls for Prompt 3 generation.
...
export interface PromptScriptEvent {
  event: "script";
  data: {
...
export interface PromptCharacterEvent {
  event: "character";
  data: {
    name: string;
    description: string;
 ...
 */
export interface PromptPhaseCache {
  jobId: string;
  videoUrl: string;
  timestamp: number;
...
export interface PromptLogUpdateEvent {
  event: "logUpdate";
  data: GeminiLogEntry;
}

export interface PromptBatchCompleteEvent {
  event: "batchComplete";
  data: {
    batchNumber: number;
    scenes: Scene[];
...
export interface PromptResumeData {
  jobId: string;
  videoUrl: string;
...
export type PromptJobStatus = "completed" | "failed" | "partial" | "in_progress";

export interface CachedPromptJob {
  jobId: string;
  videoId: string;
  videoUrl: string;
  summary: PromptJobSummary;
  ...
  status: PromptJobStatus; // Job completion status
  error?: {
    message: string;
    type: PromptErrorType;
...
export interface CachedPromptJobInfo {
  jobId: string;
  videoId: string;
  videoUrl: string;
  sceneCount: number;
...
// ============================================================================
// Prompt 3 PROMPTING GUIDE - Audio System
// ============================================================================
...
/**
 * Complete audio specification for Prompt 3
 */
...
// ============================================================================
// Prompt 3 PROMPTING GUIDE - Dialogue System
// ============================================================================

/**
 * Dialogue specification with Prompt 3 colon format
...
// ============================================================================
// Prompt 3 PROMPTING GUIDE - Enhanced Camera System
// ============================================================================
...
/**
 * Enhanced camera position with Prompt 3 "(thats where the camera is)" syntax
 */
export interface EnhancedCameraPosition {
  ...
  // Prompt 3: Precise positioning with "(thats where the camera is)" syntax
  position?: string;          // "at counter level", "behind interviewer"
  height?: CameraHeight;
  distance?: CameraDistance;

  // Prompt 3: Timing controls
  movementTiming?: {
...
// ============================================================================
// Prompt 3 PROMPTING GUIDE - Expression Control
// ============================================================================
...
// ============================================================================
// Prompt 3 PROMPTING GUIDE - Advanced Composition
// ============================================================================
...
// ============================================================================
// Prompt 3 PROMPTING GUIDE - Platform & Format
// ============================================================================
...
// ============================================================================
// Prompt 3 PROMPTING GUIDE - Quality Systems
// ============================================================================
...
// ============================================================================
// Prompt 3 PROMPTING GUIDE - Enhanced Character Template
// ============================================================================
...
// ============================================================================
// Prompt 3 PROMPTING GUIDE - Template System
// ============================================================================
...
export interface PromptFormSettings {
  ...
  // Selfie mode (genuine shot-type toggle — Prompt 3 techniques are integrated by default)
  selfieMode: boolean;
}

 ...
 * POST /api/prompt/jobs/fix-orphaned - Fix jobs stuck in "in_progress" that have scenes
 */

import { NextRequest, NextResponse } from "next/server";
import { listJobs, getJob, upsertJob } from "@/lib/prompt/d1-client";
...
/**
 * POST /api/prompt/jobs/fix-orphaned - Fix orphaned jobs

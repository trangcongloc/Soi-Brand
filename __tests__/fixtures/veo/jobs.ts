 ...
 * Ready-to-use CachedVeoJob fixtures for common test scenarios
 */

import type { CachedVeoJob } from "@/lib/veo/types";
import {
  CACHE_TTL_MS,
 ...
 */
export const completedJob: CachedVeoJob = createMockJob({
 ...
 */
export const completedJobMinimal: CachedVeoJob = createMockJob({
 ...
 */
export const completedJobNearExpiry: CachedVeoJob = createMockJob({
 ...
 */
export const inProgressJob: CachedVeoJob = createMockJob({
 ...
 */
export const inProgressJobStart: CachedVeoJob = createMockJob({
 ...
 */
export const stalledJob: CachedVeoJob = createMockJob({
  jobId: "stalled-001",
 ...
 */
export const failedJob: CachedVeoJob = createMockJob({
  jobId: "failed-001",
 ...
 */
export const failedJobRateLimit: CachedVeoJob = createMockJob({
 ...
 */
export const failedJobTimeout: CachedVeoJob = createMockJob({
 ...
 */
export const failedJobParseError: CachedVeoJob = createMockJob({
 ...
 */
export const partialJob: CachedVeoJob = createMockJob({
  jobId: "partial-001",
 ...
 */
export const emptyJob: CachedVeoJob = createMockJob({
  jobId: "empty-001",
 ...
 */
export const expiredJob: CachedVeoJob = createMockJob({
  jobId: "expired-001",
 ...
 */
export const expiredFailedJob: CachedVeoJob = createMockJob({
 ...
 */
export const hybridModeJob: CachedVeoJob = createMockJob({
  jobId: "hybrid-001",
 ...
 */
export const imageMediaTypeJob: CachedVeoJob = createMockJob({
 ...
 */
export const allJobs: CachedVeoJob[] = [
  completedJob,
  completedJobMinimal,
 ...
 */
export const resumableJobs: CachedVeoJob[] = [
  inProgressJob,
  inProgressJobStart,
  stalledJob,
  failedJob,
 ...
 */
export const errorJobs: CachedVeoJob[] = [
  failedJob,
  failedJobRateLimit,
  failedJobTimeout,
  failedJobParseError,
 ...
 */
export const expiredJobs: CachedVeoJob[] = [
  expiredJob,
  expiredFailedJob,
];

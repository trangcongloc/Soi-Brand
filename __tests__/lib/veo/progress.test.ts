 ...
 * @module __tests__/lib/veo/progress.test.ts
 */
...
import {
  ...
  getProgressMessage,
  serverProgress,
} from "@/lib/veo/progress";

import type { VeoProgress, Scene, CharacterRegistry } from "@/lib/veo/types";
...
describe("VEO Progress", () => {
  ...
  describe("updateProgressAfterBatch", () => {
    const baseProgress: VeoProgress = {
      jobId: "test-123",
      mode: "hybrid",
      youtubeUrl: "https://youtube.com/watch?v=abc123",
      videoId: "abc123",

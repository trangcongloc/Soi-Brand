 ...
 * @module __tests__/lib/veo/cache.test.ts
 */
...
describe("VEO Cache", () => {
  ...
  function createMockCachedJob(
    ...
    const mockSummary: VeoJobSummary = {
      mode: "hybrid",
  ...
  describe("getCachedJob", () => {
    ...
    it("returns null for expired job and removes it", () => {
      ...
      expect(localStorageData["veo_job_expired-job"]).toBeUndefined();
    });
  ...
  describe("setCachedJob", () => {
    ...
    it("enforces MAX_TOTAL_JOBS limit by removing oldest", () => {
      ...
      expect(localStorageData["veo_job_job-new"]).toBeDefined();
    });
  });
  ...
  describe("clearExpiredJobs", () => {
    it("removes expired jobs", () => {
      ...
      expect(localStorageData["veo_job_valid"]).toBeDefined();
      expect(localStorageData["veo_job_expired"]).toBeUndefined();
    });
    ...
    it("keeps valid jobs", () => {
      ...
      expect(localStorageData["veo_job_job-1"]).toBeDefined();
      expect(localStorageData["veo_job_job-2"]).toBeDefined();
    });
  });
  ...
  describe("clearAllJobs", () => {
    it("removes all VEO jobs from localStorage", () => {
      ...
      expect(localStorageData["veo_job_job-1"]).toBeUndefined();
      expect(localStorageData["veo_job_job-2"]).toBeUndefined();
  ...
  describe("Error handling", () => {
    it("handles corrupted JSON in localStorage gracefully", () => {
      localStorageData["veo_job_corrupted"] = "not valid json{{{";

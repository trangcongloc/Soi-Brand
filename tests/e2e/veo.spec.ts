...
test.describe('VEO Page - UI/UX Tests', () => {
...
test.describe('VEO Page - Form Validation Tests', () => {
  test.beforeEach(async ({ page }) => {
    await page.goto(VEO_URL);
    await waitForPageLoad(page);
  });
...
test.describe('VEO Page - Workflow Tests', () => {
  test.beforeEach(async ({ page }) => {
    await page.goto(VEO_URL);
    await waitForPageLoad(page);
  });
...
test.describe('VEO Page - Simultaneous Processing Test', () => {
...
test.describe('VEO Page - History Panel Tests', () => {
  test.beforeEach(async ({ page }) => {
    await page.goto(VEO_URL);
    await waitForPageLoad(page);
  });
...
test.describe('VEO Page - Error Handling Tests', () => {
  test.beforeEach(async ({ page }) => {
    await page.goto(VEO_URL);
    await waitForPageLoad(page);
  });
...
test.describe('VEO Page - Accessibility Tests', () => {
  test.beforeEach(async ({ page }) => {
    await page.goto(VEO_URL);
    await waitForPageLoad(page);
  });

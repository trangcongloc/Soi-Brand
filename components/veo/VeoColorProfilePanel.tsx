...
import { CinematicProfile } from "@/lib/veo/types";
import { useLang } from "@/lib/lang";
import styles from "./VeoColorProfilePanel.module.css";
    ...
    <div className={styles.panel}>
      <div className={styles.header} onClick={() => setIsExpanded(!isExpanded)}>
        <div className={styles.headerLeft}>
          ...
          <span className={styles.title}>{lang.veo.result.colorProfile.title}</span>
          <span className={styles.confidence}>
            {Math.round(confidence * 100)}% {lang.veo.result.colorProfile.confidence}
          </span>
        </div>
        ...
        <div className={styles.content}>
          ...
          <div className={styles.section}>
            <div className={styles.sectionTitle}>
              {lang.veo.result.colorProfile.dominantColors}
            </div>
          ...
          <div className={styles.infoGrid}>
            ...
            <div className={styles.infoCard}>
              <div className={styles.infoLabel}>
                ...
                {" "}{lang.veo.result.colorProfile.temperature}
              </div>
            ...
            <div className={styles.infoCard}>
              <div className={styles.infoLabel}>
                <SunDimIcon size={12} />
                {" "}{lang.veo.result.colorProfile.contrast}
              </div>
              <div className={styles.infoValue}>
            ...
            <div className={styles.infoCard}>
              <div className={styles.infoLabel}>
                <FilmIcon size={12} />
                {" "}{lang.veo.result.colorProfile.filmStock}
              </div>
              <div className={styles.infoValue}>
            ...
            <div className={styles.infoCard}>
              <div className={styles.infoLabel}>
                ...
                {" "}{lang.veo.result.colorProfile.shadowsHighlights}
              </div>
              <div className={styles.detailsList}>
                <div className={styles.detailItem}>
          ...
          <div className={styles.section}>
            <div className={styles.sectionTitle}>
              <HeartIcon size={12} />
              {" "}{lang.veo.result.colorProfile.mood}
            </div>
          ...
          <div className={styles.infoGrid}>
            <div className={styles.infoCard}>
              <div className={styles.infoLabel}>
                {lang.veo.result.colorProfile.grain}
              </div>
              <div className={styles.infoValue}>
            ...
            <div className={styles.infoCard}>
              <div className={styles.infoLabel}>
                {lang.veo.result.colorProfile.postProcessing}
              </div>
              <div className={styles.detailsList}>
                <div className={styles.detailItem}>

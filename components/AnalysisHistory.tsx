        ...
        <div style={{
            ...
            <div style={{
                ...
                <span style={{ fontSize: "11px", color: colors.textMuted }}>
                    {langCode === "vi" ? `${history.length} báo cáo` : `${history.length} reports`}
                </span>
            </div>
            ...
            <p style={{
                ...
                {langCode === "vi"
                    ? "Báo cáo được lưu trong 24 giờ. Có thể lưu tối đa 5 báo cáo cho mỗi kênh."
                    : "Reports are cached for 24 hours. Max 5 reports per channel."}
            </p>
        </div>
    );
};
